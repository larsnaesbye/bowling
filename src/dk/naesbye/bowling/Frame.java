...
public final class Frame {
	...
	private void validate() {
		...
		if (framesLength > 11 || (framesLength == 11 && rollsInEleven == 0)) {
			throw new RuntimeException("Too many frames in game");
		}
		...
		if (framesLength == 11 && rollsInEleven == 1 && roll2 > 0) {
			throw new RuntimeException("Too many rolls after spare in frame 10");
		}
		...
		if (roll1 < 0 || roll2 < 0 || roll1 > 10 || roll2 > 10) {
			throw new RuntimeException("Invalid number of hits");
		}
	}
}
